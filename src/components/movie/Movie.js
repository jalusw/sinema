...
export default class Movie extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = `
    <a href="#" class="group block relative min-w-[150px]   overflow-hidden" aria-label="${this._movie.original_title}">
      <img src="https://image.tmdb.org/t/p/w220_and_h330_face/${this._movie.poster_path}" class="rounded" loading="lazy" alt="" width="100%"/>
